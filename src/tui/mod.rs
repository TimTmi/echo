...
impl Default for App {
    fn default() -> Self {
        Self {
            ...
            embedding_client: EmbeddingClient::new("http://localhost:8080/v1/embeddings", "BGE-M3"),
...
impl App {
    ...
    pub fn with_config(config: &Config) -> Self {
        Self {
            ...
            embedding_client: EmbeddingClient::new(&config.embedding_url, &config.embedding_model),
            collection_browser: CollectionBrowserScreen::new(),
            search_screen: SearchScreen::new(),
            point_viewer: PointViewerScreen::new(),
    ...
    fn handle_key_press(
        ...
        match self.active_screen {
            ...
            ActiveScreen::Search => {
                let handled = self.search_screen.handle_key(code, modifiers);
                if handled {
                    return true;
                }
